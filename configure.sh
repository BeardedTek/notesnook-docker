...
# Function to save configuration to env files
save_configuration() {
    print_info "Saving configuration to env files..."
    
    # Domain configuration
    cat > env/domain.env << EOF
### Domain Setup ###
